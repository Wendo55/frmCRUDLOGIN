            ...
            <div class="card-body">
                <form v-on:submit.prevent="sesionusuario">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="clave" v-model="capturarusuario.clave"
                            name="clave" required>
                    </div>
...
export default {
    ...
    methods: {
        sesionusuario() { // metodo se llama en el post del formulario
            ...
            fetch('http://localhost/practica/?recuperar=1', {
                ...
                .then((datosRespuesta => {
                    ...
                    if (datosRespuesta.mensaje == 1) {
                        ...
                        alert("Cuenta activada, Inicie Sesión")
